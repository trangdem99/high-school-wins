...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>High School Wins - Sports Archive Collection</title>
        <meta name="description" content="Browse high school sports archives with historical stats, comparisons, and game logs." />
      </Head>
