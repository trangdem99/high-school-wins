...
/**
 * FIX G: Comparison header with team logo/letter and team colors.
 */
...
/**
 * FIX G: Comparison mode shows ALL stats from single team mode.
 * Determines winner by comparing numeric values.
 */
...
/**
 * FIX H: Head-to-head section
 * - Single continuous vertical divider line
 * - Equal height stat rows
 * - No brown/cream on date column
 * - Team names align above scores
 */
export function HeadToHeadSection({
  ...
  return (
    <div className="table-section">
      ...
      {/* FIX H: Game table - no brown highlight on date, team names align above scores */}
